/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../siliconbeest/wrangler.rpc-typegen.jsonc --env-file=../scripts/typegen-consumer.env` (hash: ff5b36024dc37c912b2a844e9be7e8ba)
