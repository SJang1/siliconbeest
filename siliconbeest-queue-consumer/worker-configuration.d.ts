/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../siliconbeest/wrangler.rpc-typegen.jsonc --env-file=../scripts/typegen-consumer.env` (hash: cfa81ae86cea5a6f46e3742dee12921e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INSTANCE_DOMAIN" | "INSTANCE_TITLE" | "REPOSITORY_URL" | "REGISTRATION_MODE" | "SKIP_SIGNATURE_VERIFICATION" | "DEBUG" | "D1_WRITE_BATCH_MAX_OPERATIONS" | "D1_WRITE_BATCH_MAX_WAIT_MS" | "QUEUE_CONSUMER_WALL_BUDGET_MS" | "SENTRY_DSN" | "OTP_ENCRYPTION_KEY">> {}
}
