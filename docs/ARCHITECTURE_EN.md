...
- `INTERNAL` (Service binding) -- invokes the main Worker's private `Internal` RPC entrypoint for Durable Object access
...
| `INTERNAL` | Service Binding (RPC) | `siliconbeest` / `Internal` entrypoint |
