/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.typegen.jsonc --env-file=../scripts/typegen.env` (hash: 6787f30a62619f24a477bc8eff2850dc)
// Runtime types generated with workerd@1.20260701.1 2026-06-16 nodejs_compat
interface __BaseEnv_Env {
	CACHE: KVNamespace;
	SESSIONS: KVNamespace;
	FEDIFY_KV: KVNamespace;
	MEDIA_BUCKET: R2Bucket;
	DB_META_C000: D1Database;
	QUEUE_INBOX: Queue;
	QUEUE_FEDERATION: Queue;
	QUEUE_INTERNAL: Queue;
	QUEUE_EMAIL: Queue;
	QUEUE_DB_INSERT: Queue;
	QUEUE_DB_UPDATE: Queue;
	...
	SETUP_SECRET: string;
	SENTRY_DSN: string;
	STREAMING_DO: DurableObjectNamespace<import("./server/index").StreamingDO>;
	STREAM_FANOUT_DO: DurableObjectNamespace<import("./server/index").StreamFanoutDO>;
	REALTIME_FEED_DO: DurableObjectNamespace<import("./server/index").RealtimeFeedIndexDO>;
	WRITE_JOURNAL_DO: DurableObjectNamespace<import("./server/index").WriteJournalDO>;
	IDENTITY_RESERVATION_DO: DurableObjectNamespace<import("./server/index").IdentityReservationDO>;
	INVITATION_LEDGER_DO: DurableObjectNamespace<import("./server/index").InvitationLedgerDO>;
	REGISTRATION_JOURNAL_DO: DurableObjectNamespace<import("./server/index").RegistrationJournalDO>;
	REMOTE_OBJECT_JOURNAL_DO: DurableObjectNamespace<import("./server/index").RemoteObjectJournalDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/index");
		durableNamespaces: "StreamingDO" | "WriteJournalDO" | "IdentityReservationDO" | "InvitationLedgerDO" | "RegistrationJournalDO" | "RemoteObjectJournalDO" | "StreamFanoutDO" | "RealtimeFeedIndexDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INSTANCE_DOMAIN" | "INSTANCE_TITLE" | "REPOSITORY_URL" | "REGISTRATION_MODE" | "SKIP_SIGNATURE_VERIFICATION" | "DEBUG" | "WORKERS_AI_ENABLED" | "WORKERS_AI_RECOMMENDATION_MODEL" | "WORKERS_AI_TRANSLATION_MODEL" | "WORKERS_AI_IMAGE_CAPTION_MODEL" | "WORKERS_AI_RATE_LIMITS" | "WORKERS_AI_RECOMMENDATION_RATE_LIMIT_PERIOD_SECONDS" | "WORKERS_AI_TRANSLATION_RATE_LIMIT_PERIOD_SECONDS" | "WORKERS_AI_IMAGE_DESCRIPTION_RATE_LIMIT_PERIOD_SECONDS" | "ASYNC_STATUS_WRITES" | "ASYNC_REGISTRATION_WRITES" | "SEARCH_FEED_READS" | "D1_WRITE_BATCH_MAX_OPERATIONS" | "D1_WRITE_BATCH_MAX_WAIT_MS" | "STREAM_PUBLIC_BRANCH_FACTOR" | "STREAM_PUBLIC_TREE_DEPTH" | "STREAM_PUBLIC_LEAF_MAX_SOCKETS" | "STREAM_USER_MAX_SOCKETS" | "STREAM_SOCKET_MAX_BUFFERED_BYTES" | "STREAM_EVENT_MAX_BYTES" | "OTP_ENCRYPTION_KEY" | "SETUP_SECRET" | "SENTRY_DSN">> {}
}
