...
declare namespace Cloudflare {
	...
	interface Env {
		...
		QUEUE_EMAIL: Queue;
		ASSETS: Fetcher;
		INSTANCE_DOMAIN: "siliconbeest.sjang.dev";
		INSTANCE_TITLE: "SiliconBeest by siliconsjang";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INSTANCE_DOMAIN" | "INSTANCE_TITLE" | "REGISTRATION_MODE" | "SKIP_SIGNATURE_VERIFICATION">> {}
}
