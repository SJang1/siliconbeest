...
app.get('/:id/following', authOptional, requireScope('read:accounts'), async (c) => {
  ...
  const baseUrl = `https://${domain}/api/v1/accounts/${accountId}/following`;
